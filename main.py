rom fastapi import FastAPI # Framework para crear la API 
from dotenv import load_dotenv # Carga variables de entorno desde 
.env 
...
load_dotenv() # Inicializa la carga de variables de entorno (ej. credenciales DB, etc.)
app = FastAPI(
    title="API de Maquillaje", # Título mostrado en la documentación
    automática (Swagger) 
